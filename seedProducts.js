...
const products = [
  ...
  // Home
  { name: 'Table Lamp', emoji: '💡', category: 'Home', price: 1299, originalPrice: 2499, rating: 4.4, reviews: 890, badge: 'BEST SELLER', description: 'LED desk lamp with dimmer', stock: 70 },
  { name: 'Wall Clock', emoji: '🕐', category: 'Home', price: 899, originalPrice: 1799, rating: 4.3, reviews: 1230, description: 'Silent wall clock', stock: 85 },
  { name: 'Cushion Cover', emoji: '🛋️', category: 'Home', price: 399, originalPrice: 799, rating: 4.2, reviews: 2340, description: 'Cotton cushion cover set', stock: 160 },
  { name: 'Photo Frame', emoji: '🖼️', category: 'Home', price: 599, originalPrice: 1199, rating: 4.5, reviews: 1670, badge: 'SALE', description: 'Wooden photo frame', stock: 95 },
  { name: 'Candle Set', emoji: '🕯️', category: 'Home', price: 799, originalPrice: 1599, rating: 4.6, reviews: 2100, badge: 'TOP RATED', description: 'Scented candle set of 3', stock: 110 },
  { name: 'Flower Vase', emoji: '🏺', category: 'Home', price: 1099, originalPrice: 2199, rating: 4.4, reviews: 780, description: 'Ceramic flower vase', stock: 60 },
  { name: 'Area Rug', emoji: '🧶', category: 'Home', price: 2499, originalPrice: 4999, rating: 4.5, reviews: 560, badge: 'BEST SELLER', description: '5x7 feet area rug', stock: 45 },
  { name: 'Curtains', emoji: '🪟', category: 'Home', price: 1499, originalPrice: 2999, rating: 4.3, reviews: 1120, description: 'Blackout curtains set', stock: 75 },
  { name: 'Bedsheet Set', emoji: '🛏️', category: 'Home', price: 1999, originalPrice: 3999, rating: 4.6, reviews: 3400, badge: 'SALE', description: 'Cotton bedsheet with pillow covers', stock: 90 },
  { name: 'Towel Set', emoji: '🧺', category: 'Home', price: 899, originalPrice: 1799, rating: 4.4, reviews: 2890, description: 'Bath towel set of 4', stock: 120 },
